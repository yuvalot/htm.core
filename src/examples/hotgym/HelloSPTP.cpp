...
//    cout << x << "\n" << sin(x) << "\n" << input << "\n\n";
    ...
    if (e == EPOCHS - 1) {
      ...
      const SDR_sparse_t deterministicTM{
        17, 37, 62, 72, 73, 93, 134, 261, 268, 269, 301, 309, 323, 331, 337, 338, 432, 493, 502, 523, 532, 542, 645, 754, 833, 921, 952, 1102, 1114, 1507, 1508, 1512, 1627, 1693, 1858, 1861, 1870, 1917, 1925, 1927, 1929, 1937, 1938, 1941, 1943, 1944, 1945, 1946, 1947, 1950, 1952, 1955, 1956, 1959, 1960, 1964, 1966, 1969, 1971, 1974, 1975, 1978, 1979, 1987, 1990, 1991,1995, 1996, 1998, 1999, 2002, 2012, 2027, 2040, 2042
      };
      goldTM.setSparse(deterministicTM);

      const float goldAn    = 0.5f;
      const float goldAnAvg = 0.386638f;
