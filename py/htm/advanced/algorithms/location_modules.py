...
class AbstractLocationModule(ABC):
    ...
    def _learn(self, learningSegments, activeInput, potentialOverlaps):
        ...
        for segment in learningSegments:
            ...
            if maxNew > 0:
                self.connections.growSynapses(segment, activeInput.sparse, maxNew, self.initialPermanence, self.rng)
    ...
    def _learnOnNewSegments(self, newSegmentCells, growthCandidates):
        ...
        for cell in  newSegmentCells:
            ...
            self.connections.growSynapses(newSegment, growthCandidates.sparse, numNewSynapses, self.initialPermanence, self.rng)
